...
#boxshadow::after {
    ...
    bottom: 0;
         ...
         <div class="form-header">
         	<h3 class="form-title"><i class="fa fa-user"></i> Donor Registration</h3>
             ...
             <!--/password-->
              ...
              <div class="row">
                   ...
                   <div class="form-group col-lg-6">
                        <div class="input-group">
                        <div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
                        <input name="code" type="text" maxlength="6" class="form-control" required placeholder="Enter your pin code">
                        </div>  
              ...
              <div class="form-group">
                   ...
                   <input type="file" name="data" class="form-control" placeholder="Upload Photo" required>
                   </div> 
