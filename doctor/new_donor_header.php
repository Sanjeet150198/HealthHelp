...
<nav class="navbar navbar-inverse navbar-fixed-top navbar-collapse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" target="_self" href="#index.php">HealthCare Health</a>
    </div>
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          <li><a href="dashboard.php"> <span class="glyphicon glyphicon-dashboard" > </span> Dashboard </a></li>
          <li><a href="view_patient.php"> <i class="fa fa-stethoscope"></i> View Patient </a></li>
          <li><a href="profile.php"> <span class="glyphicon glyphicon-user" > </span>My Details </a></li>
          <li><a href="view_disease.php"><span class="glyphicon glyphicon-plus-sign"></span> View Disease</a></li>
