...
if($_SERVER['REQUEST_METHOD']=="POST"){
	...
	if(!empty($old_pwd) && !empty($new_pwd) && !empty($cnew_pwd)){
			$msg=$obj->reset_pwd("admin",$old_pwd,$new_pwd,$cnew_pwd);
		}else{
        ...
        <div class="container-fluid">
            ...
            <div class="row">
				...
				<div class="row">
                    ...
                    <div id="msg"></div>
                    <?php 
                    $access=$obj->fetch("admin",array("name","phone"),$_SESSION["id"]);
                    if(!empty($access)):
                    ...
                    <form id="update_profile_form">
                        ...
                        <div class="form-group">
                        <input type="text" name="phone" value="<?= $row->phone?>" placeholder="Enter your Phone No." class="form-control">
                        </div>
