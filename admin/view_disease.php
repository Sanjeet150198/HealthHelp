...
$result=$obj->fetch_data("disease",array("sym_id","sym_name","disease","type","medicine"));
?>
<style>
...
<h3><a href="../users/add_disease.php" style="color:#3376B4;">Click Here</a> to add more Disease</h3>
